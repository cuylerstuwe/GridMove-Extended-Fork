;GridMove (3-digit command fork by Cuyler Stuwe aka salembeats)
;By jgpaiva
;date: May 2006 (Forked/modified 2/8/2018)
...
;      StoreWindowState(WindowId,WinLeft,WinTop,WinWidth,WinHeight)
  ...
  Command3:
    ...
    OSDwrite(Output)
    Input,ThirdNumber,I L1 T2,{esc}{enter},1,2,3,4,5,6,7,8,9,0

    If (FirstNumber = 0 and SecondNumber = 0)
      GridNumber := ThirdNumber
    Else If(FirstNumber = 0)
      GridNumber := SecondNumber . ThirdNumber
    Else
      GridNumber := FirstNumber . SecondNumber . ThirdNumber
